-- =====================================================
-- PASO 8: CORRECCIÓN FAVORITES DELETE POLICY
-- =====================================================
-- Corrige específicamente la política favorites_delete_optimized_final
-- =====================================================
...
WHERE schemaname = 'public'
    ...
    AND policyname = 'favorites_delete_optimized_final';

-- Crear política temporal corregida
DROP POLICY IF EXISTS "favorites_delete_temp" ON public.favorites;
CREATE POLICY "favorites_delete_temp" ON public.favorites
...
ALTER POLICY "favorites_delete_temp" ON public.favorites RENAME TO "favorites_delete_optimized_final";
