-- =====================================================
-- PASO 4: CORRECCIÓN USERS DELETE POLICY
-- =====================================================
-- Corrige específicamente la política users_delete_optimized_final
-- =====================================================
...
WHERE schemaname = 'public'
    AND tablename = 'users'
    AND policyname = 'users_delete_optimized_final';
...
ALTER POLICY "users_delete_temp" ON public.users RENAME TO "users_delete_optimized_final";
