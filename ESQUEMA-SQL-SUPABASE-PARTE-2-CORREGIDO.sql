-- =====================================================================================
-- ESQUEMA SQL SUPABASE - PARTE 2 CORREGIDA: POLÍTICAS RLS Y CONFIGURACIÓN DE STORAGE
-- =====================================================================================
-- Continuación del esquema principal para Misiones Arrienda - VERSIÓN CORREGIDA
-- =====================================================================================
...
SELECT 
    ...
    CASE WHEN array_length(up_a.photos, 1) > 0 THEN up_a.photos[1] ELSE NULL END as user_a_photo,
    CASE WHEN array_length(up_b.photos, 1) > 0 THEN up_b.photos[1] ELSE NULL END as user_b_photo
