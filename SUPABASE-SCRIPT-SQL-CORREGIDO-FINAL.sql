-- =====================================================
-- SCRIPT SQL SUPABASE CORREGIDO - VERSIÓN FINAL
-- Basado en testing exhaustivo con credenciales reales
-- =====================================================
...
-- Política para ver perfiles (todos pueden ver perfiles públicos)
...
-- Política para actualizar perfiles (solo el propio usuario)
CREATE POLICY "Users can update their own profile" ON public.profiles
    FOR UPDATE USING (auth.uid()::text = id::text);

-- Política para eliminar perfiles (solo el propio usuario)
CREATE POLICY "Users can delete their own profile" ON public.profiles
    FOR DELETE USING (auth.uid()::text = id::text);

-- =====================================================
-- 4. POLÍTICAS DE SEGURIDAD PARA PROPERTIES
-- =====================================================

-- Política para ver propiedades (todos pueden ver propiedades activas)
CREATE POLICY "Properties are viewable by everyone" ON public.properties
    FOR SELECT USING (is_active = true);

-- Política para insertar propiedades (solo usuarios autenticados)
...
-- Política para eliminar propiedades (solo el propietario)
...
-- NOTA: Estos datos se insertarán solo si no existen propiedades
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM public.properties LIMIT 1) THEN
        -- Crear un usuario de ejemplo para las propiedades
        INSERT INTO public.profiles (id, email, full_name, user_type, phone, location)
        VALUES (
            '00000000-0000-0000-0000-000000000001',
            'ejemplo@misionesarrienda.com',
            'Usuario de Ejemplo',
            'propietario',
            '+54 376 123-4567',
            'Posadas, Misiones'
        ...
        INSERT INTO public.properties (
            user_id, title, description, price, property_type, operation_type,
            address, city, bedrooms, bathrooms, area_total, garage, contact_phone
        ) VALUES
        (
            '00000000-0000-0000-0000-000000000001',
            'Casa en Posadas Centro',
            'Hermosa casa de 3 dormitorios en el centro de Posadas, cerca de todos los servicios.',
            150000.00,
            'casa',
            'alquiler',
            'Av. Mitre 1234',
        ...
        (
            ...
            'Moderno departamento de 2 dormitorios con todas las comodidades.',
            80000.00,
            'departamento',
            'alquiler',
