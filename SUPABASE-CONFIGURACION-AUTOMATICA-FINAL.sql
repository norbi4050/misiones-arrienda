-- =====================================================
-- CONFIGURACIÓN AUTOMÁTICA SUPABASE - MISIONES ARRIENDA
-- =====================================================
-- Fecha: 03/09/2025
-- Objetivo: Configurar políticas RLS y permisos automáticamente
-- =====================================================
...
-- 2. CREAR POLÍTICAS PARA TABLA PROFILES
-- =====================================================
...
-- Política de inserción: Usuarios pueden crear su propio perfil
...
-- 3. CREAR POLÍTICAS PARA TABLA PROPERTIES
-- =====================================================
...
-- Política de actualización: Usuarios pueden actualizar sus propias propiedades
