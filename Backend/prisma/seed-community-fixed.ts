...
async function seedCommunity() {
  ...
  const userProfiles = [
    { name: 'Ana García', email: 'ana.garcia@comunidad.com', role: 'BUSCO', city: 'Posadas' },
    { name: 'Carlos López', email: 'carlos.lopez@comunidad.com', role: 'BUSCO', city: 'Oberá' },
    { name: 'María Rodríguez', email: 'maria.rodriguez@comunidad.com', role: 'BUSCO', city: 'Posadas' },
    { name: 'Juan Pérez', email: 'juan.perez@comunidad.com', role: 'BUSCO', city: 'Oberá' },
    { name: 'Laura Martínez', email: 'laura.martinez@comunidad.com', role: 'BUSCO', city: 'Posadas' },
    { name: 'Roberto Silva', email: 'roberto.silva@comunidad.com', role: 'OFREZCO', city: 'Posadas' },
    { name: 'Carmen Díaz', email: 'carmen.diaz@comunidad.com', role: 'OFREZCO', city: 'Oberá' },
    { name: 'Diego Morales', email: 'diego.morales@comunidad.com', role: 'OFREZCO', city: 'Posadas' },
    { name: 'Patricia Vega', email: 'patricia.vega@comunidad.com', role: 'OFREZCO', city: 'Oberá' },
    { name: 'Andrés Castro', email: 'andres.castro@comunidad.com', role: 'OFREZCO', city: 'Posadas' }
  ]
  ...
  for (const userData of userProfiles) {
    ...
    users.push({ ...user, profileRole: userData.role, profileCity: userData.city })
  }
  ...
  const profilesData = [
    ...
    },
    {
      ...
      photos: ['https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop&crop=face']
    },
    {
      role: 'OFREZCO',
      city: 'Oberá',
      ...
      photos: ['https://images.unsplash.com/photo-1551836022-deb4988cc6c0?w=400&h=400&fit=crop&crop=face']
    },
    {
      role: 'OFREZCO',
      city: 'Posadas',
      ...
      photos: ['https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=400&fit=crop&crop=face']
    }
  ]
  ...
  for (let i = 0; i < 8; i++) {
    const fromProfile = createdProfiles[Math.floor(Math.random() * createdProfiles.length)]
    const toProfile = createdProfiles[Math.floor(Math.random() * createdProfiles.length)]
  ...
  console.log(`✅ Created ${createdProfiles.length} community profiles`)
  console.log(`✅ Created ${offerProfiles.length * 1.5} rooms (approx)`)
  console.log(`✅ Created sample likes and conversations`)
