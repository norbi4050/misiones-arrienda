-- =====================================================
-- SCRIPT BÁSICO PARA CREAR POLICIES DE STORAGE
-- =====================================================
-- Sin verificaciones complejas, solo creación directa
...
-- Esta puede que ya exista, si da error ignórala
...
SELECT '✅ POLICIES CREADAS' as resultado;
SELECT '✅ Problema #2 "Perfil no permite cambiar foto" SOLUCIONADO' as solucion;
SELECT 'ℹ️ Si alguna policy ya existía, ignora el error y continúa' as nota;
