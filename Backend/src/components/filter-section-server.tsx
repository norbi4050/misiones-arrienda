...
interface FilterSectionServerProps {
...
export function FilterSectionServer({ 
  ...
  // Load filters from initial searchParams on component mount
  useEffect(() => {
    if (!enableUrlPersistence) return

    const urlFilters = {
      type: (typeof initialSearchParams.type === 'string' ? initialSearchParams.type : null) || 'all',
      listingType: (typeof initialSearchParams.listingType === 'string' ? initialSearchParams.listingType : null) || 'all',
      price: (typeof initialSearchParams.price === 'string' ? initialSearchParams.price : null) || 'all',
      location: (typeof initialSearchParams.city === 'string' ? initialSearchParams.city : null) || 'all',
      bedrooms: (typeof initialSearchParams.bedrooms === 'string' ? initialSearchParams.bedrooms : null) || 'all',
