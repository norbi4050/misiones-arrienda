          ...
          <div className="max-w-lg mx-auto">
            <div className="bg-gradient-to-b from-white to-gray-50 rounded-2xl shadow-lg border border-gray-100 p-8 text-center">
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">
                Descubre las mejores propiedades de la provincia. Casas, departamentos y habitaciones compartidas en las mejores ubicaciones.
              </p>
              ...
              <div className="space-y-4">
                ...
                <a
                  href="/publicar"
                  className="inline-flex items-center px-6 py-2 border-2 border-blue-600 text-blue-600 font-medium rounded-full hover:bg-blue-600 hover:text-white transition-all duration-200"
                >
